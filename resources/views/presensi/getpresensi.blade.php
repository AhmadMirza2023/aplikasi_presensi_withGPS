...
@foreach ($presensi as $d)
    ...
    <tr>
        ...
        <td>{{ $d->nama_dept }}</td>
        <td>{!! $d->jam_in != null ? $d->jam_in : '<span class="badge text-bg-danger">Belum Absen</span>' !!}</td>
        <td>
            @if ($d->foto_in != null)
                <img src="{{ url($foto_in) }}" class="avatar" alt="Foto Absen Masuk">
            @else
        ...
        <td>{!! $d->jam_out != null ? $d->jam_out : '<span class="badge text-bg-warning">Belum Absen</span>' !!}</td>
        <td>
            @if ($d->foto_out != null)
                <img src="{{ url($foto_out) }}" class="avatar" alt="Foto Absen Pulang">
            @else
