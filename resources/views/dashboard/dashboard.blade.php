...
@section('content')
    ...
    <div class="section" id="user-section">
        ...
        <div id="user-detail">
            ...
            <div id="user-info">
                <h2 id="user-name" style="font-size: 1.2rem; margin-bottom: 1rem">
                    {{ Auth::guard('karyawan')->user()->nama_lengkap }}</h2>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body text-center" style="padding: 15px !important">
                                <span class="badge bg-danger"
                                    style="position: absolute; top: 3px; right: 3px">{{ $rekapPresensi->jmlHadir }}</span>
                                <ion-icon name="people-outline" style="font-size: 1.6rem"
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 15px !important">
                                <span class="badge bg-danger"
                                    style="position: absolute; top: 3px; right: 3px">{{ $rekapIzin->jmlIzin }}</span>
                                <ion-icon name="mail-outline" style="font-size: 1.6rem"
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 15px !important">
                                <span class="badge bg-danger"
                                    style="position: absolute; top: 3px; right: 3px">{{ $rekapIzin->jmlSakit }}</span>
                                <ion-icon name="skull-outline" style="font-size: 1.6rem"
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center" style="padding: 15px !important">
                                <span class="badge bg-danger"
                                    style="position: absolute; top: 3px; right: 3px">{{ $rekapPresensi->jmlTelat }}</span>
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span
                                            class="badge badge-success">{{ $d->jam_in != null ? $d->jam_in : 'Belum Absen' }}</span>
                                        <span
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span
                                            class="badge {{ $d->jam_in > '07:00' ? 'bg-danger' : 'bg-success' }}">{{ $d->jam_in }}</span>
                                    </div>
                                </div>
                            </li>
                        @endforeach
