...
@section('content')
    ...
    <div class="modal modal-blur fade show" id="modal-inputdepartemen" tabindex="-1" aria-hidden="true" role="dialog">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" class="form-control" placeholder="Kode Dept"
                                        name="kode_dept" id="nik">
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div class="modal modal-blur fade show" id="modal-editdepartemen" tabindex="-1" aria-hidden="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
